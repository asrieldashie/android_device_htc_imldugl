...
DEVICE_PATH := device/htc/htc_imldugl
...
# Assert
TARGET_OTA_ASSERT_DEVICE := htc_imldugl
...
TARGET_KERNEL_SOURCE := kernel/htc/htc_imldugl
TARGET_KERNEL_CONFIG := htc_imldugl_defconfig
